...
In Chapter \ref{ch:background}, the background of the problem and previous research are presented.
In Chapter \ref{ch:implementation}, the proposal is shown and the new method's implementation is explained in detail.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{ardrone_dos}
