...
In Chapter \ref{ch:intro}, the field is introduced and the purpose of the research is stated.
In Chapter \ref{ch:background}, the background of the problem, previous research, and the proposed method are presented.
...
Finally, conclusions and proposals for future work are presented in Chapter \ref{ch:conclusion}.
...
\begin{figure}[h]
  ...
  \end{subfigure}
  \caption{Various methods of displaying a \gls{fpv} feed.}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  ...
  \caption{Signal strength of the Ar.Drone with respect to distance. Extracted from \cite{ardrone_dos}.}
...
The signal profile of the AR.Drone, which is used in this research, is shown in Figure \ref{fig:ardrone_dos}.
