...
\section{Data analysis}
  ...
  The results of \gls{nasatlx} and the survey were analyzed using a paired $t$ test. Because the population size was small, the effect size was calculated using Hasting's \sym{effect}, such that:
